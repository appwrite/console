            ...
            <div class="u-flex u-flex-vertical">
                ...
                <p class="body-text-2">
                    ...
                    <span
                        class="icon-info"
                        use:tooltip={{
                            content: `You can add unlimited organization members on the ${tierToPlan($organization.billingPlan).name} plan ${$organization.billingPlan === BillingPlan.PRO ? `for ${formatCurrency(plan.usage.member.price)} each per billing period.` : '.'}`
                        }}></span>
                </p>
            </div>
            <Paginator
