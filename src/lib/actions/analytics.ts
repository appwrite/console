...
export enum Submit {
    ...
    OrganizationPaymentSet = 'submit_organization_payment_set',
    OrganizationPaymentRemove = 'submit_organization_payment_remove',
    OrganizationBackupPaymentSet = 'submit_organization_backup_payment_set',
    OrganizationBackupPaymentUpdate = 'submit_organization_backup_payment_update',
    OrganizationBackupPaymentRemove = 'submit_organization_backup_payment_remove',
    OrganizationBillingAddressSet = 'submit_organization_billing_address_set',
    OrganizationBillingAddressRemove = 'submit_organization_billing_address_remove',
